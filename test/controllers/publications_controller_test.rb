...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { chapeau: @publication.chapeau, contenu: @publication.contenu, lien: @publication.lien, titre: @publication.titre } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { chapeau: @publication.chapeau, contenu: @publication.contenu, lien: @publication.lien, titre: @publication.titre } }
