...
class ActionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create action" do
    assert_difference('Action.count') do
      post actions_url, params: { action: { contact_id: @action.contact_id, intitulé: @action.intitulé, mémo: @action.mémo } }
    end
  ...
  test "should update action" do
    patch action_url(@action), params: { action: { contact_id: @action.contact_id, intitulé: @action.intitulé, mémo: @action.mémo } }
